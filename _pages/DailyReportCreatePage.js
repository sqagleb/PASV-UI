...
import {hoursStudiedInputs, howWasYourDayInputs} from "../_data/dailyReportsCreate.data";
import DiaryPage from "./DailyReportsPage";

class DailyReportCreatePage extends AppPage {
...
export default new DailyReportCreatePage();
